module.exports = {
  ...
  extends: ['eslint:recommended', 'plugin:react/recommended', 'plugin:prettier/recommended', 'plugin:@typescript-eslint/recommended', 'standard', 'prettier'],
  ...
  rules: {
    ...
    'sort-class-members/sort-class-members': [
      2,
      {
        order: ['[static-properties]', '[static-methods]', '[getters]', '[conventional-private-properties]', 'constructor', '[arrow-function-properties]'],
      },
    ],
